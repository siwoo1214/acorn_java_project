...
public class EventManage {
	...
	private String[][] easyQuizzes = {
        {"은행에 돈을 맡기면 받을 수 있는 이자는?", "① 환율", "② 금리", "③ 배당금", "④ 세금", "2"},
    ...
    private String[][] hardQuizzes = {
        {"DSR (총부채원리금상환비율)은 무엇을 의미할까요?", "① 대출자의 총 부채를 연소득과 비교한 비율", "② 은행 예금 금리 변화율", "③ 환율 변동과 외환 보유량 변화", "④ 기업 법인세 비율", "1"},
        {"채권과 주식의 가장 큰 차이점은?", "① 채권은 회사 소유권, 주식은 회사 부채", "② 채권은 고정 이자, 주식은 변동 배당", "③ 주식은 은행만 발행 가능", "④ 둘 다 자동 현금 변환", "2"},
